...
**By Julien Barbier**
Project to be done in teams of 2 people (your team: IK Arigbe-Osula, Mohamed chakir)
...
- shell.c - initialize the program with infinite loop by call the prompt function
